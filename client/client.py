...
def parse_args():
    parser = argparse.ArgumentParser(description='Semantic Segmentation Client')
    # model and dataset
    parser.add_argument('--sever_data_dir', type=str,
                        default='/home/wmy/wmy/summer_project/image-segmentation-practice/sever_data_dir',
                        help='path to the sever data')    
    # local(change)
    parser.add_argument('--sever_hostname', type=str, default="172.18.53.xx", help=', sever hostname')
    parser.add_argument('--sever_port', type=int, default=22, help='sever port')
    
    parser.add_argument('--sever_username', type=str, default="wmy", help='sever username')
    parser.add_argument('--sever_password', type=str, default="011015", help='sever username')
